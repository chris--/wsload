...
var Testsuite = module.exports = function(param_suiteNumber, param_suiteName, param_suiteTimeout, param_suiteFunctions, param_preTestFunction, param_globalUserVar){
	...
	this.suiteResult = new Object; //Object for the results
	...
	this.suiteResult.testcases = new Array(); //save test results here
	...
	if(param_preTestFunction) {
		...
		this.preTestFunction = function(cb){cb();};
	}
...
Testsuite.prototype._addResult = function(param_testcase, param_timeInMs) {
	...
	this.suiteResult.testcases.push(param_testcase);
